...
public class OneAppl {
	...
	public OneAppl(boolean flag){
		PubSubClient joubert = new PubSubClient("joubert", "0.0.0.0", 8081);
		//PubSubClient debora = new PubSubClient("debora", "localhost", 8082);
		//PubSubClient jonata = new PubSubClient("jonata", "localhost", 8083);

		joubert.subscribe("0.0.0.0", 8080);
		//debora.subscribe("0.0.0.0", 8080);
		//jonata.subscribe("0.0.0.0", 8080);

//		joubert.subscribe("0.0.0.0", 8085);
//		debora.subscribe("0.0.0.0", 8085);
//		jonata.subscribe("0.0.0.0", 8085);

		Thread accessOne = new ThreadWrapper(joubert, "joubert_acquire_x1", "0.0.0.0", 8080);
		//Thread accessFive = new ThreadWrapper(debora, "jonata_acquire_x1", "localhost", 8080);
...
//		}
		...
		ActionListener ac = event -> {
			...
			Thread accessOne = new ThreadWrapper(client, "joubert_acquire_x1", "0.0.0.0", 8080);
			accessOne.start();
			try {
				accessOne.join();
			} catch (Exception e) {
