...
public class TwoAppl {
    ...
    public TwoAppl(boolean flag){
        ...
        PubSubClient debora = new PubSubClient("gabriel", "0.0.0.0", 8083);
...
//		jonata.subscribe("localhost", 8085);
        ...
        Thread accessOne = new ThreadWrapper(debora, "gabriel_acquire_x1", "0.0.0.0", 8080);
        ...
        try {
            ...
            while (!pause) {
                try {
                    List<Message> logJoubert = debora.getLogMessages();
//						if (!isFirstTime)
//							logJoubert.wait();
//						else
//							isFirstTime = false;
...
//        }
        ...
        ActionListener ac = event -> {
            ...
            Thread accessOne = new ThreadWrapper(client, "gabriel_acquire_x1", "0.0.0.0", 8080);
            accessOne.start();
            try {
                accessOne.join();
            } catch (Exception e) {
