...
public class PubSubClient {
	...
	public void subscribe(String brokerAddress, int brokerPort){
		try {
			...
			// Quando a mensagem é enviada na rede a função doSomething é executada novamente 
			// e a partir dela o o command syncNewPrimary eh executado
	...
	public void publish(String message, String brokerAddress, int brokerPort){		
		try{
			...
			if(response.getType().equals("backup")){			
				...
				// System.out.print("CAIUUUUUUUUUUUUUUUUUUU");
